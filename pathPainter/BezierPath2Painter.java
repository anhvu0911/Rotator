...
public class BezierPath2Painter implements PathPainter {
		...
		for (int i = 0; i < rList.size() - 1; i++) {
			...
			for (int j = 0; j < r1.angles.length; j++) {
				...
				if(j+1 < r1.angles.length){
					curve.setCurve(r1.positionX[j], r1.positionY[j], r2.positionX[j], r2.positionY[j], r1.positionX[j+1], r1.positionY[j+1]);
				}else{
					curve.setCurve(r1.positionX[j], r1.positionY[j], r2.positionX[j], r2.positionY[j], r1.positionX[0], r1.positionY[0]);
				}
	...
	public String toString(){
		return BezierPath2Painter.class.getSimpleName();
	}
